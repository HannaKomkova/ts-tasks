...
// console.log(rectangle.calculateArea(7,7));
...
//     start(){
//         console.log('завести машину');
//     }
//     stop(){
//         console.log('остановить машину');
//     }
// }
// class Motorcycle extends Vehicle{
//     start(){
//         console.log('завести байк');
//     }
//     stop(){
//         console.log('остановить байк');
//     }
// }
// const car = new Car();
// car.start();
...
// interface IApple{
//     fruits:IFruits[];
//     getAppleInfo():IFruits[];
// }
// class Apple extends Fruit{
//     fruits:IFruits[] = [ {"id": 1, "title": "яблоко", "price": 50}, 
//         {"id": 2, "title": "банан", "price": 30}, 
//         {"id": 3, "title": "груша", "price":45} ]
//     getAppleInfo(){
//        return this.fruits.filter((el) => el.title === 'яблоко')
//     }
// }
...
//     }
//     isValidEmail(){
//         let patternEmail = /^[A-Za-z0-9\.\-\_]+@[a-z]+\.[a-z]{2,3}$/gm;
//         return patternEmail.test(this.email)? true : false;
//     }
//     isValidDate(){
//         let patterDate = /^[0-9]{1,2}\.[0-9]{1,2}\.[0-9]{4}/gm;
//         return patterDate.test(this.date)? true : false;
//     }
//     isValidPath(){
//         let patterPath = /[A-Z]\:\\[A-Za-z]+\\[A-Za-zа-яА-Я]+\\[A-Za-zа-яА-Я]+\\[A-Za-zа-яА-Я]+/gm;
//         return patterPath.test(this.path)? true : false;
//     }
// }
...
//     }
//     getAverage(){
//         let sum :number= this.array.reduce((acc:number,el:number) => acc+=el, 0)
...
// }
// class StringManipulator implements iString{
...
//         let vowels:string[] = ['a', 'e', 'o', 'i', 'u']
//         return str.split('').reduce((acc:number, el:string) => vowels.includes(el)? acc+=1 : acc ,0)
//     }
// }
// const result = new StringManipulator();
// console.log(result.reverseString('hello'));
// console.log(result.isPalindrome('madam'));
// console.log(result.countVowels('manipulator'));
...
//     override showPwd(): string |void {
//         let generatePwd = super.showPwd();
...
const getStudentByID = new Student();
console.log(getStudentByID.getStudentById(2));
